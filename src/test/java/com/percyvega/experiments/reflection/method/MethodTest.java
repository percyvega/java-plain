package com.percyvega.experiments.reflection.method;
...
public class MethodTest {
    ...
    void obtain_public_own_and_inherited_methods() {
        ...
        assertThat(stringList).doesNotContain("public void com.percyvega.experiments.reflection.method.MyPet.getPetId()");
        assertThat(stringList).doesNotContain("public void com.percyvega.experiments.reflection.method.MyPet.getPetId()");

        assertThat(stringList).contains("public int com.percyvega.experiments.reflection.method.MyPet.getMaxPetEyesCount()");
        assertThat(stringList).contains("public static java.lang.String com.percyvega.experiments.reflection.method.MyPet.getFavoritePet()");
        assertThat(stringList).contains("public int com.percyvega.experiments.reflection.method.MyAnimal.getMaxAnimalEyesCount()");
        assertThat(stringList).contains("public static java.lang.String com.percyvega.experiments.reflection.method.MyAnimal.getFavoriteAnimal()");
    ...
    void obtain_public_and_private_own_methods() {
        ...
        assertThat(stringList).contains("public com.percyvega.experiments.reflection.method.MyPet com.percyvega.experiments.reflection.method.MyPet.setPetId(int)");
        assertThat(stringList).contains("public int com.percyvega.experiments.reflection.method.MyPet.getPetId()");
        assertThat(stringList).contains("public static java.lang.String com.percyvega.experiments.reflection.method.MyPet.getFavoritePet()");
        assertThat(stringList).contains("public int com.percyvega.experiments.reflection.method.MyPet.getMaxPetEyesCount()");
