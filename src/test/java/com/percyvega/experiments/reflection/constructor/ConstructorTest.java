package com.percyvega.experiments.reflection.constructor;
...
public class ConstructorTest {
    ...
    void obtain_public_and_private_own_constructors() {
        ...
        assertThat(stringList).contains("private com.percyvega.experiments.reflection.constructor.MyClass()");
        assertThat(stringList).contains("public com.percyvega.experiments.reflection.constructor.MyClass(java.lang.String)");
    ...
    void change_private_constructor_to_public_constructor() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        assertThat(myClass.getClass().getName()).isEqualTo("com.percyvega.experiments.reflection.constructor.MyClass");
    }
